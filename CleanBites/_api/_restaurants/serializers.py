...
class CommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = ["id", "commenter", "commenter_name", "restaurant", "restaurant_name", "comment", "karma", "flagged", "flagged_by", "posted_at"]
...
class ReplySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Reply
        fields = ["id", "commenter", "commenter_name", "comment", "comment_text", "reply", "karma", "flagged", "flagged_by", "posted_at"]