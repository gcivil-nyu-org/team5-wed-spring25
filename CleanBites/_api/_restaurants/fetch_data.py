...
def clean_date(value):
    ...
    try:
        return datetime.strptime(value, "%Y-%m-%dT%H:%M:%S.%f").date() if value else None
    except ValueError:
        return None
            ...
            try:
                ...
                restaurant, created = Restaurant.objects.update_or_create(
                    ...
                    defaults={
                        ...
                        "hygiene_rating": clean_hygiene_rating(item.get("score")),  # Hygiene rating is based on score
